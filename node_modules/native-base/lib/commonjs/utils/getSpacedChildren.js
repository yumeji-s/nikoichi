...
var _default = (children, space, axis, reverse, divider) => {
  ...
  const orientation = axis === 'X' ? 'vertical' : 'horizontal'; // If there's a divider, we wrap it with a Box and apply vertical and horizontal margins else we add a spacer Box with height or width
  ...
  if (divider) {
    ...
    childrenArray = childrenArray.map((child, index) => {
      ...
      }, child, index < childrenArray.length - 1 && /*#__PURE__*/_react.default.createElement(_Box.default, spacingProp));
    });
  }
